...
scan_keyword_t KeyWord::scanKeyWordsList_[] ={
	...
	TRANS_KEYWORD("cross",CROSS,RESERVED_KEYWORD),
	...
	TRANS_KEYWORD("full",FULL,RESERVED_KEYWORD),
	...
	TRANS_KEYWORD("right",RIGHT,RESERVED_KEYWORD),
	...
	TRANS_KEYWORD("using",USING,RESERVED_KEYWORD),
