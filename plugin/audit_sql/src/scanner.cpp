...
#define YY_NEW_FILE Trans_yyrestart(yyin ,yyscanner )
...
#define YY_BUFFER_NORMAL 1
	 ...
	 * (via Trans_yyrestart()), so that the user can continue scanning by
...
void Trans_yyrestart (FILE *input_file ,yyscan_t yyscanner );
void Trans_yy_switch_to_buffer (YY_BUFFER_STATE new_buffer ,yyscan_t yyscanner );
YY_BUFFER_STATE Trans_yy_create_buffer (FILE *file,int size ,yyscan_t yyscanner );
void Trans_yy_delete_buffer (YY_BUFFER_STATE b ,yyscan_t yyscanner );
void Trans_yy_flush_buffer (YY_BUFFER_STATE b ,yyscan_t yyscanner );
void Trans_yypush_buffer_state (YY_BUFFER_STATE new_buffer ,yyscan_t yyscanner );
void Trans_yypop_buffer_state (yyscan_t yyscanner );

static void Trans_yyensure_buffer_stack (yyscan_t yyscanner );
static void Trans_yy_load_buffer_state (yyscan_t yyscanner );
static void Trans_yy_init_buffer (YY_BUFFER_STATE b,FILE *file ,yyscan_t yyscanner );

#define YY_FLUSH_BUFFER Trans_yy_flush_buffer(YY_CURRENT_BUFFER ,yyscanner)

YY_BUFFER_STATE Trans_yy_scan_buffer (char *base,yy_size_t size ,yyscan_t yyscanner );
YY_BUFFER_STATE Trans_yy_scan_string (yyconst char *yy_str ,yyscan_t yyscanner );
YY_BUFFER_STATE Trans_yy_scan_bytes (yyconst char *bytes,int len ,yyscan_t yyscanner );

void *Trans_yyalloc (yy_size_t ,yyscan_t yyscanner );
void *Trans_yyrealloc (void *,yy_size_t ,yyscan_t yyscanner );
void Trans_yyfree (void * ,yyscan_t yyscanner );

#define yy_new_buffer Trans_yy_create_buffer

#define yy_set_interactive(is_interactive) \
	{ \
	if ( ! YY_CURRENT_BUFFER ){ \
        Trans_yyensure_buffer_stack (yyscanner); \
		YY_CURRENT_BUFFER_LVALUE =    \
            Trans_yy_create_buffer(yyin,YY_BUF_SIZE ,yyscanner); \
	} \
...
int Trans_yylex_init (yyscan_t* scanner);

int Trans_yylex_init_extra (YY_EXTRA_TYPE user_defined,yyscan_t* scanner);

/* Accessor methods to globals.
   These are made visible to non-reentrant scanners for convenience. */

int Trans_yylex_destroy (yyscan_t yyscanner );

int Trans_yyget_debug (yyscan_t yyscanner );

void Trans_yyset_debug (int debug_flag ,yyscan_t yyscanner );

YY_EXTRA_TYPE Trans_yyget_extra (yyscan_t yyscanner );

void Trans_yyset_extra (YY_EXTRA_TYPE user_defined ,yyscan_t yyscanner );
...
void Trans_yyset_lval (YYSTYPE * yylval_param ,yyscan_t yyscanner );

       YYLTYPE *Trans_yyget_lloc (yyscan_t yyscanner );
    
        void Trans_yyset_lloc (YYLTYPE * yylloc_param ,yyscan_t yyscanner );
...
#ifdef __cplusplus
extern "C" int Trans_yywrap (yyscan_t yyscanner );
#else
...
extern int Trans_yylex \
               (YYSTYPE * yylval_param,YYLTYPE * yylloc_param ,yyscan_t yyscanner);

#define YY_DECL int Trans_yylex \
               (YYSTYPE * yylval_param, YYLTYPE * yylloc_param , yyscan_t yyscanner)
#endif /* !YY_DECL */
	...
	case YY_END_OF_BUFFER:
		...
		*yy_cp = yyg->yy_hold_char;
		...
		if ( YY_CURRENT_BUFFER_LVALUE->yy_buffer_status == YY_BUFFER_NEW )
			 ...
			 * Trans_yylex().  If so, then we have to assure
...
static int yy_get_next_buffer (yyscan_t yyscanner)
{
	...
	if ( yyg->yy_n_chars == 0 )
		...
		if ( number_to_move == YY_MORE_ADJ )
			...
			Trans_yyrestart(yyin  ,yyscanner);
			}
    ...
    void Trans_yyrestart  (FILE * input_file , yyscan_t yyscanner)
{
	...
	Trans_yy_init_buffer(YY_CURRENT_BUFFER,input_file ,yyscanner);
	Trans_yy_load_buffer_state(yyscanner );
}
    ...
    void Trans_yy_switch_to_buffer  (YY_BUFFER_STATE  new_buffer , yyscan_t yyscanner)
{
	 ...
	 * with
	 *		Trans_yypop_buffer_state();
	 *		Trans_yypush_buffer_state(new_buffer);
     */
	Trans_yyensure_buffer_stack (yyscanner);
	 ...
	 * EOF (Trans_yywrap()) processing, but the only time this flag
	 * is looked at is after Trans_yywrap() is called, so it's safe
    ...
    YY_BUFFER_STATE Trans_yy_create_buffer  (FILE * file, int  size , yyscan_t yyscanner)
{
	...
	Trans_yy_init_buffer(b,file ,yyscanner);

	return b;
}

/** Destroy the buffer.
 * @param b a buffer created with Trans_yy_create_buffer()
 * @param yyscanner The scanner object.
 */
    void Trans_yy_delete_buffer (YY_BUFFER_STATE  b , yyscan_t yyscanner)
{
	...
	if ( b->yy_is_our_buffer )
		Trans_yyfree((void *) b->yy_ch_buf ,yyscanner );
...

{
	...
	Trans_yy_flush_buffer(b ,yyscanner);

	b->yy_input_file = file;
	b->yy_fill_buffer = 1;

    /* If b is the current buffer, then Trans_yy_init_buffer was _probably_
     * called from Trans_yyrestart() or through yy_get_next_buffer.
...
void Trans_yypush_buffer_state (YY_BUFFER_STATE new_buffer , yyscan_t yyscanner)
{
	...
	/* This block is copied from Trans_yy_switch_to_buffer. */
	if ( YY_CURRENT_BUFFER )
		{
		/* Flush out information for old buffer. */
		*yyg->yy_c_buf_p = yyg->yy_hold_char;
	...
	/* copied from Trans_yy_switch_to_buffer. */
	Trans_yy_load_buffer_state(yyscanner );
	yyg->yy_did_buffer_switch_on_eof = 1;
}
...
void Trans_yypop_buffer_state (yyscan_t yyscanner)
{
	...
	Trans_yy_delete_buffer(YY_CURRENT_BUFFER ,yyscanner);
...
static void Trans_yyensure_buffer_stack (yyscan_t yyscanner)
{
	...
	if (!yyg->yy_buffer_stack) {
		...
		yyg->yy_buffer_stack = (struct yy_buffer_state**)Trans_yyalloc
								...
								, yyscanner);
		if ( ! yyg->yy_buffer_stack )
			YY_FATAL_ERROR( "out of dynamic memory in Trans_yyensure_buffer_stack()" );
...
YY_BUFFER_STATE Trans_yy_scan_buffer  (char * base, yy_size_t  size , yyscan_t yyscanner)
{
	...
	Trans_yy_switch_to_buffer(b ,yyscanner );

	return b;
}

/** Setup the input buffer state to scan a string. The next call to Trans_yylex() will
 * scan from a @e copy of @a str.
 * @param yystr a NUL-terminated string to scan
 * @param yyscanner The scanner object.
 * @return the newly allocated buffer state object.
 * @note If you want to scan bytes that may contain NUL values, then use
 *       Trans_yy_scan_bytes() instead.
 */
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE Trans_yy_scan_bytes  (yyconst char * yybytes, int  _yybytes_len , yyscan_t yyscanner)
{
	YY_BUFFER_STATE b;
	char *buf;
	yy_size_t n;
	...
	b = Trans_yy_scan_buffer(buf,n ,yyscanner);
	if ( ! b )
		YY_FATAL_ERROR( "bad buffer in Trans_yy_scan_bytes()" );
...
/* Trans_yylex_init is special because it creates the scanner itself, so it is
 * the ONLY reentrant function that doesn't take the scanner as the last argument.
 * That's why we explicitly handle the declaration, instead of using our macros.
 */

int Trans_yylex_init(yyscan_t* ptr_yy_globals)

{
    ...
    *ptr_yy_globals = (yyscan_t) Trans_yyalloc ( sizeof( struct yyguts_t ), NULL );
...
/* Trans_yylex_init_extra has the same functionality as Trans_yylex_init, but follows the
 * convention of taking the scanner as the last argument. Note however, that
 * this is a *pointer* to a scanner, as it will be allocated by this call (and
 * is the reason, too, why this function also must handle its own declaration).
 * The user defined value in the first argument will be available to Trans_yyalloc in
 * the yyextra field.
 */

int Trans_yylex_init_extra(YY_EXTRA_TYPE yy_user_defined,yyscan_t* ptr_yy_globals )

{
    struct yyguts_t dummy_yyguts;

    Trans_yyset_extra (yy_user_defined, &dummy_yyguts);
    ...
    *ptr_yy_globals = (yyscan_t) Trans_yyalloc ( sizeof( struct yyguts_t ), &dummy_yyguts );
    ...
    Trans_yyset_extra (yy_user_defined, *ptr_yy_globals);
...
/* Trans_yylex_destroy is for both reentrant and non-reentrant scanners. */
int Trans_yylex_destroy  (yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
	...
	while(YY_CURRENT_BUFFER){
		Trans_yy_delete_buffer(YY_CURRENT_BUFFER ,yyscanner );
		YY_CURRENT_BUFFER_LVALUE = NULL;
		Trans_yypop_buffer_state(yyscanner);
	}

	/* Destroy the stack itself. */
	Trans_yyfree(yyg->yy_buffer_stack ,yyscanner);
	yyg->yy_buffer_stack = NULL;

    /* Destroy the start condition stack. */
        Trans_yyfree(yyg->yy_start_stack ,yyscanner );
        yyg->yy_start_stack = NULL;

    /* Reset the globals. This is important in a non-reentrant scanner so the next time
     * Trans_yylex() is called, initialization will occur. */
    yy_init_globals( yyscanner);

    /* Destroy the main struct (reentrant only). */
    Trans_yyfree ( yyscanner , yyscanner );
    yyscanner = NULL;
    return 0;
}
