...
-- in 5.6 or previous version the max length of index is set to 767 bytes in innodb or 1000 bytes in MyISAM, in 5.7 is set to 3000 bytes.
CREATE TABLE IF NOT EXISTS sql_pattern ( sql_text varchar(128) DEFAULT '' NOT NULL, sql_pattern varchar(2048) DEFAULT '' NOT NULL, sql_md5 varchar(512) DEFAULT '' NOT NULL, sql_action varchar(16) DEFAULT '' NOT NULL, PRIMARY KEY(sql_text)) engine=InnoDB STATS_PERSISTENT=0 CHARACTER SET utf8 COLLATE utf8_general_ci comment='MySQL sql patterns';
